...
export const musteriIfadeleri: Testimonial[] = [
  ...
  {
    ad: 'Tanju Bey',
    unvan: 'Proje Müdürü / Proje Ortağı',
    firma: 'Fortis Enerji',
    firmaSlug: 'fortis-enerji',
    // logoBase: henüz Fortis Enerji logosu yok, logo eklendiğinde aktif olur
    proje: 'Smart Güneş Enerji Santrali — Çivril/Denizli, 100 MW, 35.000 mini kazık',
    yil: 2024,
    metin: 'Çivril sahasındaki güneş enerji santrali temelinde 35.000 adet kazığı 4 ayda tamamlamak gerekiyordu. Bloklu kireçtaşı ve dolgulu zemin koşullarında klasik delgi sistemleri yetersiz kalırdı. Torem ekibi havalı sistem mini kazık makineleriyle sahaya girdi ve süreç boyunca panel kurulum ekibinin takvimini geriye çekmedi.',
    vurgu: 'Zorlu saha şartlarında ve bloklu, dolgulu zemin koşullarında doğru makine ve ekipman seçimiyle proje başarıyla tamamlanmıştır.',
  },
  {
    ad: 'Hakan Zeray',
